           ...
           <aside class="main-sidebar">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="box-title"><i class='fa fa-edit'><u> Listado Inventario</u></i></h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><font color="blue">PSE :</font></label>
                                <input class="form-control" type="text" placeholder="PSE">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label><font color="blue">Marca :</font></label>
                        ...
                        <div class="col-md-3">
                            <label><font color="blue">Estado :</font></label>
                            <select class="form-control select2"  data-placeholder="Seleccione" style="width: 100%;">
                                <option value="" disabled selected>Seleccione</option>
                                <option>Producción</option>
                                <option>Usado</option>
                                <option>Nuevo</option>
                                <option>Inutilizable</option>
                                <option>Baja</option>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-hover table-striped ">
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    <td class="text-center">I0001013</td>
                                                    <td class="text-cente"> Locutorio Tele
                                                    </td>
                                                    <td class="text-left">Wincor Nixdorf</td>
                                                    <td>Pro Cash 1500</td>
                                                    <td>5300272199</td>
                                                    <td class="text-left">
                                                        Av. Franciso Moreno245</td>
                                                    <!--td class="text-center">Surquillo</td>
                                                    <td class="text-right">Lima</td>
                                                    <td class="text-right">Lima</td>
                                                    <td class="text-left">Punto Neutro</td>
                                                     <td class="text-left">Locutorios</td-->
                                                    <td class="text-left">Ni idea</td>
                                                    <td class="text-left">ATM</td>
                                                    <td> <font color="red">Baja</font></td>
