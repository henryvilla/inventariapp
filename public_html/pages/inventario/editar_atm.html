                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    <div id="load_img">
                                        <img class=" img-responsive" src="../imagenes/atm_1500.png" alt="Bussines profile picture">
                                    </div>

                                    <h3 class="profile-username text-center">Pro Cash 1500 XE</h3>
                            ...
                            <form name="update_register" id="update_register" class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class=""><a href="#address" data-toggle="tab" aria-expanded="false">Precios & Stock</a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="details">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="product_code" name="product_code"  value="I0001013" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="model" name="model" value="HIEJSmk" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="product_name" name="product_name" value="Hp 54" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="note" class="col-sm-2 control-label">Modelo</label>
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" name="note" id="note">9de octubre</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="file" name="imagefile" id="imagefile" onchange="upload_image(30);">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="buying_price" name="buying_price" value="1" required pattern="\d+(\.\d{2})?" title="precio con 2 decimales">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="selling_price" name="selling_price" value="2" required pattern="\d+(\.\d{2})?" title="precio con 2 decimales">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="stock" name="stock" value="996.00">
                                                    </div>
                                                </div>
                                            </div>
