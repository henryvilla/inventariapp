          ...
          <aside class="main-sidebar">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="box-title"><i class='fa fa-edit'><u> Reportes Inventario</u></i></h1>
                    <ol class="breadcrumb">
                ...
                <section class="content-header">
                        ...
                        <div class="col-md-12">
                            <div class="box" >
                                <div class="box-header with-border">
                                    <center> <font face="Arial" size="5" >  <b>Reporte de ATM'S en Producción </b></font> </center>
                                </div>
                                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box" >
                                <div class="box-header with-border">
                                    <center> <font face="Arial" size="5" >  <b>Reporte de ATM'S en Pastel </b></font> </center>
                                </div>
                                <div class="box-body">
                                                    ...
                                                    data: [
                                                        {
                                                            ...
                                                            dataPoints: [
                                                                {y: 83.24, legendText: "Producción", label: "Producción"},
                                                                {y: 8.16, legendText: "Nuevo", label: "Nuevo"},
                                                                {y: 4.67, legendText: "Usado", label: "Usado"},
                                                                {y: 1.67, legendText: "Inutilizable", label: "Inutilizable"},
                                                                {y: 0.98, legendText: "Baja", label: "Baja"}
                                                            ]
                                                        }
                                                    ]
                                                });
